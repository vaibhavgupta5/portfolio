...
function ResumePage() {
  return (
    <div className="p-6 md:p-8  ">
      ...
      <div className=" flex  md:ml-4 ml-4 items-center gap-8 mb-8 ">
        <div className=" border-[4px] flex h-full items-start  p-0 border-[#ffdb6e6c] rounded-full">
          <div className="rounded-full p-1 bg-[#FFDB6E]"></div>
        </div>
      ...
      <div className="  flex flex-col  mt-6 gap-6  ">
        <TracingBeam className="   md:ml-16  ">
          <div className="ml-12 md:ml-1 text-[15px] flex flex-col gap-1">
            <div className=" font-bold"> Web Development </div>
            <div className=" font-normal md:w-[80%] text-[#d6d6d6]">
        ...
        <TracingBeam className="   md:ml-16 pb-6 ">
          <div className="ml-12 md:ml-1 text-[15px] flex flex-col gap-1">
