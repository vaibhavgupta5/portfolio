    ...
    <div className="p-8  ">
          ...
          
      {
            paginatedProjects.map((project, index) => (
                <div key={index} className="bg-[#222224]   group relative flex flex-col gap-1 p-4 rounded-xl border-t-[2px] border-l-[2px] border-[#3C3C3C]">
                ...
                <div className={`relative w-full group h-full  mb-4`}>
                  ...
                  >
                    { project.links.website !== "" && <div onClick={ () => redirectTo(project.links.website)} className="p-3 cursor-pointer border-[#3C3C3C] border-[2px] rounded-full bg-[#2B2B2C]">
                      <IoMdLink className="text-2xl" />
                    </div>}
      
                    <div onClick={ () => redirectTo(project.links.github)} className="p-3 cursor-pointer rounded-full border-[#3C3C3C] border-[2px] bg-[#2B2B2C]">
                ...
                <div className="flex gap-1 flex-wrap mt-2">
                  ...
                  { project.stack[2] && <p className="text-[15px] bg-[#2B2B2C]  pr-3 pl-3 rounded-md  text-[#d6d6d6]">
                    {project.stack[2]}
                  </p>}
                </div>
              </div>
